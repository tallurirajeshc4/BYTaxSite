<%@ Page Title="" Language="C#" MasterPageFile="~/Outer.Master" AutoEventWireup="true" CodeBehind="Indiantax.aspx.cs" Inherits="BYTAX.Indiantax" %>
    ...
    <h5> Contact us today to create a tailored tax plan that works for you.</h5>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden rounded ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="assets/img/services/itr2.jpg" alt="" style="object-fit: cover;">
