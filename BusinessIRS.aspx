<%@ Page Title="" Language="C#" MasterPageFile="~/Outer.Master" AutoEventWireup="true" CodeBehind="BusinessIRS.aspx.cs" Inherits="BYTAX.BusinessIRS" %>
    ...
    <h5>Contact us today for reliable support and peace of mind during an IRS audit.</h5>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden rounded ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="assets/img/services/b4.jpg" alt="" style="object-fit: cover;">
