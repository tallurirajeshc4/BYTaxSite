<%@ Page Title="" Language="C#" MasterPageFile="~/Outer.Master" AutoEventWireup="true" CodeBehind="Indianincome.aspx.cs" Inherits="BYTAX.Indianincome" %>
    ...
    <h5>Contact us to make your Indian income tax filing seamless and hassle-free.</h5>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden rounded ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="assets/img/services/itr1.jpg" alt="" style="object-fit: cover;">
